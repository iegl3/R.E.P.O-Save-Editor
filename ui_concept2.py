...
class App(CTk):
    def __init__(self):
        ...
        self.checkbox_frame_1 = MyCheckboxFrame(self, title="Frame 1", values=["value 1", "value 2", "value 3"])
        self.checkbox_frame_1 = MyCheckboxFrame(self, title="Frame 1", values=["value 1", "value 2", "value 3"])
        self.checkbox_frame_1.grid(row=0, column=0, padx=10, pady=(10, 0), sticky="nsew")
        self.checkbox_frame_2 = MyCheckboxFrame(self, title="Frame 2", values=["option 1", "option 2"])
